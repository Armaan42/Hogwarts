...
**Submodule Code:** CRISIS-004  
**Category:** Incident & Crisis Management  
**Priority:** High (P1)

## Overview

This submodule handles crisis communication functionality within the Incident & Crisis Management module.

## Purpose

Manage and track all aspects of crisis communication within the Incident & Crisis Management module. This submodule provides comprehensive tools for creating, monitoring, and reporting on crisis communication activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
```
Record Type: Crisis Communication
...
**Performance Metrics:**
```
Crisis Communication - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Crisis Communication Records:
  Keyword: [text search]
...
```sql
CREATE TABLE crisis_communication (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve crisis communication records.
...
```
1. Authorized User → Initiates new crisis communication record
