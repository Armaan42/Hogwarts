# 06 Prescriptive Analytics

**Module:** 46 Analytics Insights  
**Submodule Code:** 46-06  
...
Manage and track all aspects of prescriptive analytics within the 46 Analytics Insights module. This submodule provides comprehensive tools for creating, monitoring, and reporting on prescriptive analytics activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
```
Record Type: Prescriptive Analytics
...
**Performance Metrics:**
```
Prescriptive Analytics - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Prescriptive Analytics Records:
  Keyword: [text search]
...
```sql
CREATE TABLE prescriptive_analytics (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve prescriptive analytics records.
...
```
1. Authorized User → Initiates new prescriptive analytics record
