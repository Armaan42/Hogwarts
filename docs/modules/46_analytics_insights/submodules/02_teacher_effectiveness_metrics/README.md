...
**Submodule Code:** ANALYTICS-002  
**Category:** Analytics & Insights  
**Priority:** Critical (P0)

## Overview

This submodule handles teacher effectiveness metrics functionality within the Analytics & Insights module.

## Purpose

Manage and track all aspects of teacher effectiveness metrics within the Analytics & Insights module. This submodule provides comprehensive tools for creating, monitoring, and reporting on teacher effectiveness metrics activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
**Dashboard Overview:**
```
Teacher Effectiveness Metrics Dashboard
Module: Analytics & Insights
...
```
Record Type: Teacher Effectiveness Metrics
...
**Performance Metrics:**
```
Teacher Effectiveness Metrics - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Teacher Effectiveness Metrics Records:
  Keyword: [text search]
...
```sql
CREATE TABLE teacher_effectiveness_metrics (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve teacher effectiveness metrics records.
...
```
1. Authorized User → Initiates new teacher effectiveness metrics record
