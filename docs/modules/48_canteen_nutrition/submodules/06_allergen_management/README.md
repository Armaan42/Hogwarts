# 06 Allergen Management

**Module:** 48 Canteen Nutrition  
**Submodule Code:** 48-06  
...
Manage and track all aspects of allergen management within the 48 Canteen Nutrition module. This submodule provides comprehensive tools for creating, monitoring, and reporting on allergen management activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
```
Record Type: Allergen Management
...
**Performance Metrics:**
```
Allergen Management - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Allergen Management Records:
  Keyword: [text search]
...
```sql
CREATE TABLE allergen_management (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve allergen management records.
...
```
1. Authorized User → Initiates new allergen management record
