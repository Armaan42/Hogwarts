# 07 Food Waste Tracking

**Module:** 48 Canteen Nutrition  
**Submodule Code:** 48-07  
...
Manage and track all aspects of food waste tracking within the 48 Canteen Nutrition module. This submodule provides comprehensive tools for creating, monitoring, and reporting on food waste tracking activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
```
Record Type: Food Waste Tracking
...
**Performance Metrics:**
```
Food Waste Tracking - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Food Waste Tracking Records:
  Keyword: [text search]
...
```sql
CREATE TABLE food_waste_tracking (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve food waste tracking records.
...
```
1. Authorized User → Initiates new food waste tracking record
