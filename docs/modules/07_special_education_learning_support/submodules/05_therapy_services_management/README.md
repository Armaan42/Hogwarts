...
**Submodule Code:** SPED-005  
**Category:** Special Education & Learning Support  
**Priority:** High (P1)

## Overview

This submodule handles therapy services management functionality within the Special Education & Learning Support module.

## Purpose

Manage and track all aspects of therapy services management within the Special Education & Learning Support module. This submodule provides comprehensive tools for creating, monitoring, and reporting on therapy services management activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
**Dashboard Overview:**
```
Therapy Services Management Dashboard
Module: Special Education & Learning Support
...
```
Record Type: Therapy Services Management
...
**Performance Metrics:**
```
Therapy Services Management - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Therapy Services Management Records:
  Keyword: [text search]
...
```sql
CREATE TABLE therapy_services_management (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve therapy services management records.
...
```
1. Authorized User → Initiates new therapy services management record
