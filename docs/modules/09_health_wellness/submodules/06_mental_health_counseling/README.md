...
**Submodule Code:** HEALTH-006  
**Category:** Health & Wellness  
**Priority:** High (P1)

## Overview

This submodule handles mental health & counseling functionality within the Health & Wellness module.

## Purpose

Manage and track all aspects of mental health counseling within the Health & Wellness module. This submodule provides comprehensive tools for creating, monitoring, and reporting on mental health counseling activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
**Dashboard Overview:**
```
Mental Health Counseling Dashboard
Module: Health & Wellness
...
```
Record Type: Mental Health Counseling
...
**Performance Metrics:**
```
Mental Health Counseling - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Mental Health Counseling Records:
  Keyword: [text search]
...
```sql
CREATE TABLE mental_health_counseling (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve mental health counseling records.
...
```
1. Authorized User → Initiates new mental health counseling record
