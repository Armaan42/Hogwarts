...
**Submodule Code:** HEALTH-004  
**Category:** Health & Wellness  
**Priority:** High (P1)

## Overview

This submodule handles health screening & checkups functionality within the Health & Wellness module.

## Purpose

Manage and track all aspects of health screening checkups within the Health & Wellness module. This submodule provides comprehensive tools for creating, monitoring, and reporting on health screening checkups activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
**Dashboard Overview:**
```
Health Screening Checkups Dashboard
Module: Health & Wellness
...
```
Record Type: Health Screening Checkups
...
**Performance Metrics:**
```
Health Screening Checkups - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Health Screening Checkups Records:
  Keyword: [text search]
...
```sql
CREATE TABLE health_screening_checkups (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve health screening checkups records.
...
```
1. Authorized User → Initiates new health screening checkups record
