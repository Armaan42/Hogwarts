# 02 Multi Currency Management

**Module:** 54 Internationalization Localization  
**Submodule Code:** 54-02-MUL  
...
Manage and track all aspects of multi currency management within the 54 Internationalization Localization module. This submodule provides comprehensive tools for creating, monitoring, and reporting on multi currency management activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
**Dashboard Overview:**
```
Multi Currency Management Dashboard
Module: 54 Internationalization Localization
...
```
Record Type: Multi Currency Management
...
**Performance Metrics:**
```
Multi Currency Management - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Multi Currency Management Records:
  Keyword: [text search]
...
```sql
CREATE TABLE multi_currency_management (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve multi currency management records.
...
```
1. Authorized User → Initiates new multi currency management record
