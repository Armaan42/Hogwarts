# 06 Translation Management

**Module:** 54 Internationalization Localization  
**Submodule Code:** 54-06-TRA  
...
Manage and track all aspects of translation management within the 54 Internationalization Localization module. This submodule provides comprehensive tools for creating, monitoring, and reporting on translation management activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
```
Record Type: Translation Management
...
**Performance Metrics:**
```
Translation Management - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Translation Management Records:
  Keyword: [text search]
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve translation management records.
...
```
1. Authorized User → Initiates new translation management record
