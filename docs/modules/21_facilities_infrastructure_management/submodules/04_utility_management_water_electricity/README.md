...
**Submodule Code:** FAC-004  
**Category:** Facilities & Infrastructure Management  
**Priority:** High (P1)

## Overview

This submodule handles utility management (water/electricity) functionality within the Facilities & Infrastructure Management module.

## Purpose

Manage and track all aspects of utility management water electricity within the Facilities & Infrastructure Management module. This submodule provides comprehensive tools for creating, monitoring, and reporting on utility management water electricity activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
**Dashboard Overview:**
```
Utility Management Water Electricity Dashboard
Module: Facilities & Infrastructure Management
...
```
Record Type: Utility Management Water Electricity
...
**Performance Metrics:**
```
Utility Management Water Electricity - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Utility Management Water Electricity Records:
  Keyword: [text search]
...
```sql
CREATE TABLE utility_management_water_electricity (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve utility management water electricity records.
...
```
1. Authorized User → Initiates new utility management water electricity record
