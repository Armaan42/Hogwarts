# 08 Inter Library Loan

**Module:** 18 Library Management  
**Submodule Code:** 18-08  
...
Manage and track all aspects of inter library loan within the 18 Library Management module. This submodule provides comprehensive tools for creating, monitoring, and reporting on inter library loan activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
```
Record Type: Inter Library Loan
...
**Performance Metrics:**
```
Inter Library Loan - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Inter Library Loan Records:
  Keyword: [text search]
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve inter library loan records.
...
```
1. Authorized User → Initiates new inter library loan record
