...
Manage and track all aspects of enquiry management within the Admissions & CRM module. This submodule provides comprehensive tools for creating, monitoring, and reporting on enquiry management activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
```
Record Type: Enquiry Management
...
**Performance Metrics:**
```
Enquiry Management - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Enquiry Management Records:
  Keyword: [text search]
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve enquiry management records.
...
```
1. Authorized User → Initiates new enquiry management record
