...
Manage and track all aspects of referral program within the 15 Admissions Crm module. This submodule provides comprehensive tools for creating, monitoring, and reporting on referral program activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
**Performance Metrics:**
```
Referral Program - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Referral Program Records:
  Keyword: [text search]
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve referral program records.
...
```
1. Authorized User → Initiates new referral program record
