...
**Module:** Multi-Campus Management  
**Submodule Code:** MULTI-003  
**Category:** Multi-Campus Management  
**Priority:** Critical (P0)

## Overview

This submodule handles consolidated reporting functionality within the Multi-Campus Management module.

## Purpose

Manage and track all aspects of consolidated reporting within the Multi-Campus Management module. This submodule provides comprehensive tools for creating, monitoring, and reporting on consolidated reporting activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
```
Record Type: Consolidated Reporting
...
**Performance Metrics:**
```
Consolidated Reporting - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Consolidated Reporting Records:
  Keyword: [text search]
...
```sql
CREATE TABLE consolidated_reporting (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve consolidated reporting records.
...
```
1. Authorized User → Initiates new consolidated reporting record
