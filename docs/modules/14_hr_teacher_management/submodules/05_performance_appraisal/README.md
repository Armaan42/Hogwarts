...
```
Record Type: Performance Appraisal
...
**Performance Metrics:**
```
Performance Appraisal - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Performance Appraisal Records:
  Keyword: [text search]
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve performance appraisal records.
...
```
1. Authorized User → Initiates new performance appraisal record
