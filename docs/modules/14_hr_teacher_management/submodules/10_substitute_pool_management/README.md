# 10 Substitute Pool Management

**Module:** 14 Hr Teacher Management  
**Submodule Code:** 14-10  
...
Manage and track all aspects of substitute pool management within the 14 Hr Teacher Management module. This submodule provides comprehensive tools for creating, monitoring, and reporting on substitute pool management activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
**Dashboard Overview:**
```
Substitute Pool Management Dashboard
Module: 14 Hr Teacher Management
...
```
Record Type: Substitute Pool Management
...
**Performance Metrics:**
```
Substitute Pool Management - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Substitute Pool Management Records:
  Keyword: [text search]
...
```sql
CREATE TABLE substitute_pool_management (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve substitute pool management records.
...
```
1. Authorized User → Initiates new substitute pool management record
