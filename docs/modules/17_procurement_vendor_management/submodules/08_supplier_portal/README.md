...
Manage and track all aspects of supplier portal within the 17 Procurement Vendor Management module. This submodule provides comprehensive tools for creating, monitoring, and reporting on supplier portal activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
**Performance Metrics:**
```
Supplier Portal - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Supplier Portal Records:
  Keyword: [text search]
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve supplier portal records.
...
```
1. Authorized User → Initiates new supplier portal record
