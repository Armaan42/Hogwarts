...
**Submodule Code:** CAREER-008  
**Category:** Career Guidance & University Counseling  
**Priority:** Medium (P2)

## Overview

This submodule handles post-admission support functionality within the Career Guidance & University Counseling module.

## Purpose

Manage and track all aspects of post-admission support within the Career Guidance & University Counseling module. This submodule provides comprehensive tools for creating, monitoring, and reporting on post-admission support activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
**Dashboard Overview:**
```
Post-admission Support Dashboard
Module: Career Guidance & University Counseling
...
```
Record Type: Post-admission Support
...
**Performance Metrics:**
```
Post-admission Support - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Post-admission Support Records:
  Keyword: [text search]
...
```sql
CREATE TABLE post-admission_support (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve post-admission support records.
...
```
1. Authorized User → Initiates new post-admission support record
