# UNIVERSITY DATABASE & MATCHING

**Module:** Career Guidance & University Counseling  
**Submodule Code:** CAREER-002  
**Category:** Career Guidance & University Counseling  
**Priority:** Critical (P0)

## Overview

This submodule handles university database & matching functionality within the Career Guidance & University Counseling module.

## Purpose

Manage and track all aspects of university database matching within the Career Guidance & University Counseling module. This submodule provides comprehensive tools for creating, monitoring, and reporting on university database matching activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
**Dashboard Overview:**
```
University Database Matching Dashboard
Module: Career Guidance & University Counseling
...
```
Record Type: University Database Matching
...
**Performance Metrics:**
```
University Database Matching - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search University Database Matching Records:
  Keyword: [text search]
...
```sql
CREATE TABLE university_database_matching (
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve university database matching records.
...
```
1. Authorized User → Initiates new university database matching record
