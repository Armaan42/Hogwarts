...
Manage and track all aspects of multi factor authentication within the 51 Security Access Control module. This submodule provides comprehensive tools for creating, monitoring, and reporting on multi factor authentication activities, ensuring efficient operations, regulatory compliance, and seamless integration with other school ERP modules.
...
```
Record Type: Multi Factor Authentication
...
**Performance Metrics:**
```
Multi Factor Authentication - Monthly Report (March 2026)
...
**Advanced Search:**
```
Search Multi Factor Authentication Records:
  Keyword: [text search]
...
1. **Authorization:** Only users with appropriate role permissions can create, modify, or approve multi factor authentication records.
...
```
1. Authorized User → Initiates new multi factor authentication record
